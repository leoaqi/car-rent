<template>
    ...
    <div class="bg-natural-400">
        <!-- Section Hero -->
        <section class="bg-natural-400">
            <div class="relative">
                <img :src="prambanan" alt="" class="w-full h-[300px] object-cover">
                <div class="absolute opacity-80 bg-primary inset-0 ">
                </div>
                <div class="absolute inset-0 inset-x-24 inset-y-20">
                    ...
                    <h1 class="text-white font-poppins font-normal text-xl">The Most Complete Car Rental in Yogyakarta
                    </h1>
                    <h1 class="text-white font-poppins font-normal text-sm mt-5">24-hour service with fast response
                        without
                        any hassle and various car choices for self-drive & with professional driver. Your satisfaction
                        is
                        our priority.!</h1>
                </div>
                <div
                    class="absolute bg-white px-6 py-4 -bottom-10 left-1/2 transform -translate-x-1/2 rounded-lg shadow-sm w-3/4">
                    <div class="flex flex-row gap-4 justify-evenly">
                        <div class="flex flex-row gap-3.5 items-center">
                            ...
                            <div>
                                ...
                                <h1 class="text-sm text-text-primary font-poppins font-normal">Service 24 Hour</h1>
                            </div>
                        </div>
                        <div class="flex flex-row gap-3.5 items-center">
                            <div
                            ...
                            <div>
                                ...
                                <h1 class="text-sm text-text-primary font-poppins font-normal">Delivery & Pickup</h1>
                            </div>
                        </div>
                        <div class="flex flex-row gap-3.5 items-center">
                            <div
                        ...
                        <div class="flex flex-row gap-3.5 items-center">
                            ...
                            <div>
                                <h1 class="text-xl text-primary font-poppins font-medium">Well maintained car</h1>
                                <h1 class="text-sm text-text-primary font-poppins font-normal">Clean & Well Maintained
                                    Guarantee</h1>
                            </div>
                        </div>
                    </div>
        ...
        <section class="bg-natural-400 p-2 lg:p-7 font-poppins mt-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mx-auto">
                <template v-for="car in data" :key="car.id">
                    <div class="bg-white rounded-xl py-4 px-4 shadow-xs cursor-pointer" v-on:click="router.visit(`/car-detail/${car.id}`)">
